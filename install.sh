...
install() {
    ...
    launchctl unload ~/Library/LaunchAgents/com.bendaschel.py-network-monitor.plist
    launchctl load ~/Library/LaunchAgents/com.bendaschel.py-network-monitor.plist
}
